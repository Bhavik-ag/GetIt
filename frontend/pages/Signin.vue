        ...
        <form @submit="submitForm">
          ...
          >
            ...
            <div class="remember-forgot py-[1.0rem] flex justify-between hi">
              <div class="remember-me hil">
                <input
                  ...
                  true-value="yes"
                  false-value="no"
                  v-model.trim.lazy="credentials.rememberMe"
                />
                <label
                  for="checkbox"
                  class="subpixel-antialiased font-bold text-slate-800 cursor-pointer"
                  >Remember me</label
                >
              </div>
              <div class="forgot-password hir">
                <a
                  href="#"
                  class="font-bold subpixel-antialiased tracking-wide text-slate-800 fp"
                  >Forgot password ?</a
                >
              </div>
            </div>
            ...
            <div class="optional-sign-in mt-[0.7rem] hi">
              <p class="flex justify-center gap-2 hi">
